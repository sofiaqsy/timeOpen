  ...
  <div class="row container">
      <div class="pull-right">
          <div class="mbr-navbar__column">
            ...
            <div class="mbr-navbar__column">
                  <a class="btn btn-primary active" href="?view=servicios">Crear servicio</a>
              </div>
        </div>
      <ol class="breadcrumb">
  ...
  <form class="form-horizontal" action="?view=servicios&mode=add" method="post" enctype="multipart/form-data">
    <fieldset>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <select class="form-control" name="curso" required>
            ...
            <?php
            if(false!=$_cursosporusuarios):foreach ($_cursosporusuarios as $id_cursosporusuarios => $value): ?>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="titulo" name="titulo" placeholder="Asesoria principios de Algoritmos" class="form-control input-md" required="" type="text">
          <span class="help-block">Elige un titulo para tu servicio</span>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <textarea class="form-control" id="descripcion"  required="" name="descripcion" placeholder="Se guia en para el tercer examen de algotirmos, con ejercicios de examenes pasados"></textarea>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="horas" name="horas" placeholder="2" class="form-control input-md" required="" type="text">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="lugar" name="lugar" placeholder="UTP, en la biblioteca de la sede central" class="form-control input-md" required="" type="text">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <textarea class="form-control" id="detalles" name="detalles" placeholder=" A las 5pm estare en la entrada de la biblioteca con una casaca negra"></textarea>
        </div>
      </div>

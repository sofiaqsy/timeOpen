...
<div class="modal-body">
 <form class="form-horizontal" method="post" action="?view=perfil&mode=config&id=<?php echo $id_usuario; ?>">
   <div class="form-group">
     ...
     <div class="col-sm-10">
       <input class="form-control" id="institucion"  name="institucion" placeholder="Universidad a la que perteneces">
     </div>
   </div>
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <select id="area" class="form-control" name="area">
        ...
        <?php foreach ($_areas as $id_area => $value):
          if(empty($_users[$id_usuario]['area']) && $_areas[$id_area]["idarea"]==$_users[$id_usuario]['area']): ?>
  ...
  <button type="submit" class="btn btn-default btn-success btn-block"><span class="glyphicon glyphicon-floppy-saved"></span> Guardar cambios</button>
  </form>
  </div>

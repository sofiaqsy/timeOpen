...
function LostpassTemplate($user,$link) {
  ...
  <div style="">
  	...
  	<p>El día '. date("Y/m/d H:i:s").' se ha generado una solicitud de recupeción de contraseña. <br /> Si no has solicitado esto, has caso omiso a este mensaje, en cambio si deseas modificar tu contraseña debes hacer clic en el enlace de abajo.</p>
